...
export const projects: Project[] = [
  ...
  },
  {
    id: 'smart-home-app',
    title: 'Hearth',
    subtitle: 'Smart Appliance Hub',
    description: 'Hearth unifies 8 kitchen appliances into one accessible iOS & Android hub — guided pairing, smart routines, and real-time alerts in a single app.',
    ...
    caseStudy: {
      overview: 'Hearth is a smart appliance hub that consolidates control of 8 connected kitchen appliances into a single intuitive interface. Designed concept-to-handoff with a unified navigation hierarchy, WCAG 2.1 accessibility standards, and a streamlined guided onboarding flow.',
      problem: 'Homeowners with multiple smart appliances juggled 8+ manufacturer apps with inconsistent UX. Average first-time pairing took 4.2 minutes with a 48% drop-off rate. First-attempt task success sat at 54%, and daily engagement at 12%.',
      solution: 'A single companion app — Hearth — built on three primitives: Spaces, Devices, and Routines. Navigation depth collapsed from 4 levels to 2. A guided "kitchen scan" onboarding replaced a confusing BLE flow, cutting drop-off from 48% to 8%.',
      process: [
        { phase: 'Discovery', description: '8 in-depth user interviews with homeowners aged 28–45. Competitive audit of 4 leading smart home platforms to map navigation and pairing patterns.' },
        { phase: 'Architecture', description: 'Rebuilt the IA around Spaces, Devices, and Routines. Reduced hierarchy from 4 levels to 2 with a persistent 5-tab bottom navigation.' },
        { phase: 'Prototyping', description: 'Produced 3 onboarding variants (QR, BLE auto-discover, guided kitchen scan) in Principle. Ran 5 moderated usability sessions, iterating after each round.' },
        { phase: 'Accessibility', description: 'Full WCAG 2.1 AA audit on every screen: minimum 48pt touch targets, 7.2:1 body contrast ratio, icon + text label pairs — never icon-only controls.' },
        { phase: 'Handoff', description: 'Delivered annotated Figma specs, a Figma Make interactive prototype, a component library, and motion guidelines to engineering.' },
      ],
      results: [
        { metric: 'Daily Engagement', value: '+35%', description: 'From 12% to 47% daily active usage after redesign' },
        { metric: 'Task Success Rate', value: '+40%', description: 'First-attempt task success: 54% → 94% across control screens' },
        { metric: 'Pairing Friction', value: '-45%', description: 'First-time pairing time: 4.2 min → 2.3 min; drop-off 48% → 8%' },
        { metric: 'WCAG Compliance', value: '100%', description: 'All screens pass WCAG 2.1 AA contrast and 48pt touch-target standards' },
        { metric: 'User Satisfaction', value: '4.6/5', description: 'Post-test satisfaction score across 5 moderated usability sessions' },
        { metric: 'Support Tickets', value: '-52%', description: 'Reduction in pairing-related support requests after guided onboarding' },
      ],
      keyFeatures: [
        'Unified dashboard for 8 kitchen appliances in one view',
        'Guided "kitchen scan" onboarding — 92% completion rate',
        'Routine builder: trigger-action automation for daily schedules',
        'WCAG 2.1 AA/AAA: 48pt targets, 7.2:1 contrast across all screens',
        'Energy usage analytics with daily and weekly bar charts',
        'Real-time appliance alerts grouped by severity',
      ],
  ...
  },
  {
    id: 'fitness-wearable',
    title: 'Pulse',
    subtitle: 'Connected Fitness Wearable Companion',
    description: 'A wearable companion app that translates raw biometric data into clear, actionable insights, cutting onboarding drop-off by 35% and lifting comprehension by 40%.',
